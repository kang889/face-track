...
def main() -> None:
    ...
    # Fixed dataset-wide ranges for absolute scaling.
    pred_global_min = float(np.min(pred_3[:, :, 2]))
    pred_global_max = float(np.max(pred_3[:, :, 2]))
    true_global_min = float(np.min(true_3[:, :, 2]))
    true_global_max = float(np.max(true_3[:, :, 2]))
    ...
    height_pred_relative_u8, pred_rel_min, pred_rel_max = normalize_relative_to_u8(height_pred, mask)
    height_true_relative_u8, true_rel_min, true_rel_max = normalize_relative_to_u8(height_true, mask)
    height_pred_absolute_u8 = normalize_absolute_to_u8(height_pred, pred_global_min, pred_global_max, mask)
    height_true_absolute_u8 = normalize_absolute_to_u8(height_true, true_global_min, true_global_max, mask)
    ...
    json_out = {
        ...
        "files": {
            "heightmap_pred_relative_png": "regional_heightmap_pred_relative.png",
            "heightmap_pred_absolute_png": "regional_heightmap_pred_absolute.png",
            "heightmap_true_relative_png": "regional_heightmap_true_avg_relative.png",
            "heightmap_true_absolute_png": "regional_heightmap_true_avg_absolute.png",
        ...
        "relative_scaling": {
            "pred_map_min": pred_rel_min,
            "pred_map_max": pred_rel_max,
            "true_map_min": true_rel_min,
            "true_map_max": true_rel_max
        },
        "absolute_scaling": {
            "pred_dataset_min": pred_global_min,
            "pred_dataset_max": pred_global_max,
            "true_dataset_min": true_global_min,
            "true_dataset_max": true_global_max
        },
    }
    ...
    cv2.imwrite(str(output_dir / "regional_heightmap_pred_relative.png"), height_pred_relative_u8)
    cv2.imwrite(str(output_dir / "regional_heightmap_pred_absolute.png"), height_pred_absolute_u8)
    cv2.imwrite(str(output_dir / "regional_heightmap_true_avg_relative.png"), height_true_relative_u8)
    cv2.imwrite(str(output_dir / "regional_heightmap_true_avg_absolute.png"), height_true_absolute_u8)
    ...
    print("Saved:")
    print(f"  {output_dir / 'regional_heightmap_pred_relative.png'}")
    print(f"  {output_dir / 'regional_heightmap_pred_absolute.png'}")
